...
const REQUIRED_ROOT_LINT_VALIDATORS = [
  ...
  "validate:biome-no-softenings",
  "validate:no-dead-daisyui-v4",
  "validate:no-important",
  "validate:no-raw-backdrop",
  "validate:stacking-tokens",
  "validate:no-href-hash-stubs",
  "validate:logical-css",
