...
const oklchToRelativeLuminance = (color: OklchColor): number => {
  ...
  const redLinear = clamp01(
    RATIO_4_0767416621 * lCube - RATIO_3_3077115913 * mCube + RATIO_0_2309699292 * sCube,
  );
  const greenLinear = clamp01(
    -RATIO_1_2684380046 * lCube + RATIO_2_6097574011 * mCube - RATIO_0_3413193965 * sCube,
  );
  const blueLinear = clamp01(
    -RATIO_0_0041960863 * lCube - RATIO_0_7034186147 * mCube + RATIO_1_707614701 * sCube,
  );
