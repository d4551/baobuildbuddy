...
export declare const emailTransportSecurityBodySchema: Type.TUnion<(Type.TLiteral<"plain"> | Type.TLiteral<"starttls"> | Type.TLiteral<"tls">)[]>;
export declare const emailTransportAuthModeBodySchema: Type.TUnion<(Type.TLiteral<"login"> | Type.TLiteral<"plain">)[]>;
