...
import { AUTOMATION_FINISHED_PROGRESS, isAutomationJobScrapeTarget, type AutomationScrapeTarget, type RpaCapabilityAuditReport } from "@bao/shared/constants/automation";
