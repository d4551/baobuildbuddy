import { API_ERROR_CUSTOM_ANSWERS_KEYS, API_ERROR_CUSTOM_ANSWERS_KEY_EXCEEDS, API_ERROR_CUSTOM_ANSWERS_MAX_COUNT, API_ERROR_CUSTOM_ANSWERS_OBJECT, API_ERROR_CUSTOM_ANSWERS_VALUE_EXCEEDS, API_ERROR_CUSTOM_ANSWERS_VALUE_MUST_BE_STRING, API_ERROR_JOB_URL_ABSOLUTE, API_ERROR_JOB_URL_DISALLOWED_HOST, API_ERROR_JOB_URL_EXCEEDS_LENGTH, API_ERROR_JOB_URL_HTTP_ONLY, API_ERROR_JOB_URL_NO_CREDENTIALS, API_ERROR_JOB_URL_REQUIRED } from "@bao/shared/constants/api-errors";
import { AUTOMATION_MAX_CUSTOM_ANSWER_COUNT, AUTOMATION_MAX_CUSTOM_ANSWER_KEY_LENGTH, AUTOMATION_MAX_CUSTOM_ANSWER_VALUE_LENGTH, AUTOMATION_MAX_JOB_URL_LENGTH } from "@bao/shared/constants/automation";
