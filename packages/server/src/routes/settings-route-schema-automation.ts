...
import { SCHEMA_MAX_BOARD_RESULT_LIMIT, SCHEMA_MAX_ITEMS_BOARDS, SCHEMA_MAX_ITEMS_LARGE, SCHEMA_MAX_LENGTH_ID, SCHEMA_MAX_LENGTH_LONG, SCHEMA_MAX_LENGTH_MICRO, SCHEMA_MAX_LENGTH_MODEL, SCHEMA_MAX_LENGTH_SETTINGS_LABEL, SCHEMA_MAX_LENGTH_SETTINGS_URL, SCHEMA_MAX_PAGES_MAX, SCHEMA_MAX_PAGES_MIN, SCHEMA_PROVIDER_TIMEOUT_MAX_MS, SCHEMA_PROVIDER_TIMEOUT_MIN_MS } from "@bao/shared/constants/schema-limits";
