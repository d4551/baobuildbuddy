...
import { SCHEMA_MAX_ITEMS_LARGE, SCHEMA_MAX_ITEMS_SMALL, SCHEMA_MAX_ITEMS_XXLARGE, SCHEMA_MAX_LENGTH_ACHIEVEMENT, SCHEMA_MAX_LENGTH_DATE, SCHEMA_MAX_LENGTH_DESCRIPTION, SCHEMA_MAX_LENGTH_EMAIL, SCHEMA_MAX_LENGTH_ID, SCHEMA_MAX_LENGTH_LABEL, SCHEMA_MAX_LENGTH_MICRO, SCHEMA_MAX_LENGTH_PHONE, SCHEMA_MAX_LENGTH_SHIPPED, SCHEMA_MAX_LENGTH_SHORT, SCHEMA_MAX_LENGTH_URL } from "@bao/shared/constants/schema-limits";
