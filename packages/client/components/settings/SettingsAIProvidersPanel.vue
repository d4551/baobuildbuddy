...
import {  ICON_SIZE_CLASS, SURFACE_GLASS_CARD_CLASS, FLUID_WIDTH_CLASS, PADDING_TOKEN_CLASS, MARGIN_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, STACK_SPACE_Y_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS,
...
import {  ICON_SIZE_CLASS, SURFACE_GLASS_CARD_CLASS, FLUID_WIDTH_CLASS, PADDING_TOKEN_CLASS, MARGIN_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, STACK_SPACE_Y_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, LOCAL_AI_DEFAULT_ENDPOINT } from "@bao/shared/constants/ai-provider";
import {  ICON_SIZE_CLASS, SURFACE_GLASS_CARD_CLASS, FLUID_WIDTH_CLASS, PADDING_TOKEN_CLASS, MARGIN_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, STACK_SPACE_Y_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, OPENAI_V1_ENDPOINT_PREFIX } from "@bao/shared/constants/endpoints";
import type { AIProviderType, AIRoutingPurpose } from "@bao/shared/types/ai";
import {  ICON_SIZE_CLASS, SURFACE_GLASS_CARD_CLASS, FLUID_WIDTH_CLASS, PADDING_TOKEN_CLASS, MARGIN_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, STACK_SPACE_Y_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, useI18n } from "vue-i18n";
              ...
              >
                <div class="flex items-start justify-between" :class="[FLEX_GAP_TOKEN_CLASS.gap3]">
                  <div class="flex items-start" :class="[TRUNCATE_FLEX_CHILD_CLASS, FLEX_GAP_TOKEN_CLASS.gap3]">
                    <AIProviderIcon :provider-id="provider.id" class="shrink-0 text-primary" :class="[MARGIN_TOKEN_CLASS.mt0, ICON_SIZE_CLASS.sm]" />
                ...
                <p
                  ...
                  class="text-muted" :class="[MARGIN_TOKEN_CLASS.mt3, TYPOGRAPHY_SCALE_CLASS.xs]"
                >
                  {{
