  ...
  <div class="card bg-base-100 shadow-xl">
    <div class="card-body prose max-w-none">
      ...
      <div v-if="resume.experience && resume.experience.length > 0" class="mb-6">
        <h2 class="text-2xl font-bold mb-4 border-b border-base-300 pb-2">Experience</h2>
        <div
      ...
      <div v-if="resume.education && resume.education.length > 0" class="mb-6">
        <h2 class="text-2xl font-bold mb-4 border-b border-base-300 pb-2">Education</h2>
        <div
      ...
      <div v-if="resume.skills" class="mb-6">
        <h2 class="text-2xl font-bold mb-4 border-b border-base-300 pb-2">Skills</h2>
        ...
        <div v-if="resume.skills.gaming?.length" class="mb-3">
          <h3 class="text-lg font-semibold mb-2">Gaming Industry Skills</h3>
          <div class="flex flex-wrap gap-2">
            <span
