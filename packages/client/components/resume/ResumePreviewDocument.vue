...
import {  PADDING_TOKEN_CLASS, MARGIN_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS,
    ...
    <div v-if="resume.experience?.length" :class="MARGIN_TOKEN_CLASS.mb6">
      ...
      >
        <div class="flex items-start justify-between" :class="[MARGIN_TOKEN_CLASS.mb1]">
          <div>
            <h3 class="font-bold" :class="[TYPOGRAPHY_SCALE_CLASS.lg]">{{ experience.title }}</h3>
        ...
        <p v-if="experience.description" class="whitespace-pre-wrap leading-relaxed" :class="[TYPOGRAPHY_SCALE_CLASS.sm]">
