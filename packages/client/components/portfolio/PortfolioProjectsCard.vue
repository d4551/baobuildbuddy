...
<template>
 ...
 <h2 id="portfolio-projects-title" :class="[FONT_WEIGHT_TOKEN_CLASS.bold, TYPOGRAPHY_SCALE_CLASS.xl]">{{ t("portfolioPage.projects.title") }}</h2>
      ...
      <SectionGrid v-else grid-token="threeColumnResponsive">
        ...
        >
          <figure v-if="project.image" class="overflow-hidden" :class="[CONTENT_H_48_CLASS]">
            <NuxtImg
              :src="project.image"
              :alt="project.title"
