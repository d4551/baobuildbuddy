...
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, PADDING_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, MIN_HEIGHT_ZERO_CLASS, APP_SEMVER } from "@bao/shared/constants/app-version";
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, PADDING_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, MIN_HEIGHT_ZERO_CLASS, useI18n } from "vue-i18n";
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, PADDING_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, MIN_HEIGHT_ZERO_CLASS, KEYBOARD_ROUTE_SHORTCUTS } from "~/composables/useKeyboardShortcuts";
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, PADDING_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, MIN_HEIGHT_ZERO_CLASS,
  APP_DRAWER_ID,
...
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, PADDING_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, MIN_HEIGHT_ZERO_CLASS, getSidebarNavigationItems, isRouteActive } from "~/constants/navigation";
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, PADDING_TOKEN_CLASS, FLEX_GAP_TOKEN_CLASS, TYPOGRAPHY_SCALE_CLASS, MIN_HEIGHT_ZERO_CLASS, setDrawerToggleState } from "~/utils/drawer-controls";
