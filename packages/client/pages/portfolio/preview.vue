    ...
    <div v-else-if="portfolio" class="max-w-6xl mx-auto">
      ...
      <div class="card bg-gradient-to-br from-primary to-secondary text-primary-content mb-8">
        <div class="card-body text-center py-12">
          <h1 class="text-5xl font-bold mb-4">{{ portfolio.metadata?.title || "My Portfolio" }}</h1>
          <p class="text-xl max-w-2xl mx-auto mb-6">{{ portfolio.metadata?.bio }}</p>
          <div class="flex flex-wrap justify-center gap-4">
            <a v-if="portfolio.metadata?.email" :href="`mailto:${portfolio.metadata?.email}`" class="btn btn-outline">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="card-body">
              ...
              <div v-if="project.liveUrl" class="card-actions mt-4">
                <a :href="project.liveUrl" target="_blank" class="btn btn-primary btn-xs">
                  View
