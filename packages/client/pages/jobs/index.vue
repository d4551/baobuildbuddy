...
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, ICON_SIZE_CHEVRON_CLASS, SURFACE_GLASS_CARD_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, APP_ROUTE_BUILDERS } from "@bao/shared/constants/routes";
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, ICON_SIZE_CHEVRON_CLASS, SURFACE_GLASS_CARD_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, useI18n } from "vue-i18n";
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, ICON_SIZE_CHEVRON_CLASS, SURFACE_GLASS_CARD_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS,
  BODY_TEXT_SM_CLASS,
  BODY_TEXT_XS_CLASS,
  CARD_TITLE_LG_CLASS,
  FLUID_HEIGHT_CLASS,
...
import {  ICON_DECORATIVE_STROKE_WIDTH, ICON_SIZE_CLASS, ICON_SIZE_CHEVRON_CLASS, SURFACE_GLASS_CARD_CLASS, FLUID_WIDTH_CLASS, FLUID_HEIGHT_CLASS, getErrorMessage } from "~/utils/errors";
        ...
        <div v-else>
          <SectionGrid grid-token="twoColumn" :extra-class="SECTION_GAP_BOTTOM_CLASS">
            <article
              ...
              :key="job.id"
              :class="[SURFACE_GLASS_CARD_CLASS, 'glass-card-hover relative overflow-hidden', FLUID_HEIGHT_CLASS]"
            >
              <NuxtLink
