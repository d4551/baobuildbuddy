...
import { APP_BRAND_TAGLINE, DECIMAL_RADIX, DEFAULT_APP_DESCRIPTION, DEFAULT_I18N_LOCALE_COOKIE_KEY, DEFAULT_QUERY_RETRY_COUNT, DEFAULT_QUERY_STALE_TIME_MS, LOCALES_DIRECTORY_SEGMENT, LOCALE_CHUNK_NAME_PREFIX, LOCALE_FILE_EXTENSION, MODULE_PATH_SEPARATOR, NODE_MODULES_PATH_SEGMENT, NUXT_COMPATIBILITY_DATE, PNPM_PATH_SEGMENT, QUERY_REFETCH_ON_FOCUS_DISABLED, VITE_BUILD_TARGET, WINDOWS_PATH_SEPARATOR } from "@bao/shared/constants/client-config";
