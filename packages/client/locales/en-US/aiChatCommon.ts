const aiChatCommon = {
  aiChatCommon: {
    ...
    voice: {
      ...
      testOnDeviceTitle: "Test on-device speaker",
      testOnDeviceAria: "Speak a short sample with on-device text-to-speech",
      testOnDeviceSample: "On-device text to speech is working.",
