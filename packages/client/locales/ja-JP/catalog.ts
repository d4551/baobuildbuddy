const catalog = {
  ...
  a11y: {
    ...
    aiConfigIncompleteAria: "AIプロバイダーは設定画面で構成が必要です",
  },
  confirmDialog: {
    confirmButton: "確認",
    cancelButton: "キャンセル",
  ...
  nav: {
    ...
    resume: "履歴書",
    resumeBuild: "履歴書ビルダー",
    resumePreview: "履歴書プレビュー",
    coverLetter: "カバーレター",
    portfolio: "ポートフォリオ",
    portfolioPreview: "ポートフォリオプレビュー",
    interview: "面接",
    interviewHistory: "面接履歴",
    interviewSession: "面接セッション",
    skills: "スキル",
    skillsPathways: "スキルパス",
    studios: "スタジオ",
    studiosAnalytics: "スタジオ分析",
    aiDashboard: "AIダッシュボード",
    aiChat: "AIチャット",
    automation: "自動化",
    automationJobApply: "求人応募自動化",
    automationScraper: "スクレイパー自動化",
    automationEmail: "メール自動化",
  ...
  resumePreview: {
    ...
    githubLinkAria: ["GitHub", "プロフィールを開く"].join(""),
  },
  skillsPage: {
    seoTitle: "スキルマッパー",
    title: "スキルマッパー",
  ...
  automation: {
    ...
    jobApply: {
      title: "求人応募自動化",
      bootstrapError: "求人応募自動化を読み込めませんでした。",
      bootstrapRetry: "再試行",
      bootstrapRetryAria: "求人応募自動化の読み込みを再試行",
      emptyResumesTitle: "履歴書が必要です",
      emptyResumesDescription:
        "求人応募自動化を実行する前に履歴書を作成してください。実行には選択済みの履歴書が必要です。",
      emptyResumesCta: "履歴書ビルダーを開く",
      emptyResumesCtaAria: "求人応募用の履歴書を作成するために履歴書ビルダーを開く",
      jobUrlLegend: "求人URL",
      jobUrlPlaceholder: "求人掲載URLを貼り付け",
      jobUrlAria: "求人掲載URL",
      resumeLegend: "履歴書",
      resumeAria: "履歴書を選択",
      selectResumeOption: "履歴書を選択",
      resumeFallbackName: "履歴書 {id}",
      coverLetterLegend: "カバーレター（任意）",
      coverLetterAria: "任意のカバーレターを選択",
      noCoverLetterOption: "カバーレターなし",
      coverLetterOption: "{company} の {position}",
      unknownCompany: "不明",
      unknownPosition: "職種",
      jobIdLegend: "求人ID（任意）",
      jobIdPlaceholder: "関連付け用の任意の求人ID",
      jobIdAria: "関連付け用の任意の求人ID",
      runButton: "応募を実行",
      runButtonAria: "求人応募自動化を実行",
      submitErrorTitle: "送信に失敗しました",
      submitErrorFallback: "求人応募自動化を開始できませんでした",
      runStartedTitle: "実行を開始しました",
      runIdLabel: "実行ID: {id}",
      statusLabel: "ステータス: {status}",
      openRunDetailLink: "実行詳細を開く",
      openRunDetailAria: "自動化実行 {id} の詳細ページを開く",
      schedule: {
        legend: "実行をスケジュール",
        aria: "実行時刻をスケジュール",
        hint: "この実行を開始する時刻を選択してください。",
        button: "実行をスケジュール",
        buttonAria: "求人応募自動化の実行をスケジュール",
        createdTitle: "実行をスケジュールしました",
        scheduledForLabel: "予定日時: {date}",
        invalidRunAt: "有効な未来の日時を選択してください。",
      },
      stream: {
        title: "ライブ実行ストリーム",
  ...
  settings: {
    ...
    profile: {
      ...
      githubLegend: ["GitHub", "プロフィール"].join(""),
    ...
    aiProviders: {
      ...
      openaiV1Title: "OpenAI チャット補完 API",
      openaiV1Description:
        "OpenAI SDK の向き先をこのベース URL にし、Bao API キーを Bearer トークンとして使用します（models + chat/completions）。",
      openaiV1Aria: "OpenAI Chat Completions API のベース URL",
      expandAria: "{provider} プロバイダー設定を展開",
      configuredBadge: "設定済み",
      endpointLabel: "エンドポイントURL",
      credentialLabel: "APIキー",
      huggingFacePlaceholder: "Hugging Face トークンを入力",
      apiKeyPlaceholder: "{provider} の API キーを入力",
      testAria: "AIプロバイダー接続をテスト",
      testButton: "テスト",
      localModelLegend: "ローカルモデル名",
      localModelPlaceholder: "サーバーから自動検出",
      localModelAria: "ローカルモデル名",
      connectedBadge: "接続済み",
      failedBadge: "失敗",
      saveAria: "AIプロバイダー認証情報を保存",
      saveButton: "APIキーを保存",
      ...
      readinessTitle: "プロバイダー準備状況",
      readinessDescription:
        "ワークフローへ割り当てる前に、設定と接続性を確認してください。",
      ...
      routingCoverageTitle: "ルーティング済みワークフロー",
      routingCoverageDescription:
        "各AI機能は独自のプロバイダーと任意のモデル上書きを保持できます。",
      ...
      ollamaTipLinkLabel: "Ollama 公式サイト",
      ollamaTipLinkAria: "Ollama のサイトを新しいタブで開く",
      credentialsDescription:
        "実際のワークフローへルーティングする予定のプロバイダーだけ、認証情報を保存してテストしてください。",
    },
    brand: {
    ...
    errors: {
      failedToTestProvider: "プロバイダーのテストに失敗しました",
      failedToSaveApiKeys: "APIキーの保存に失敗しました",
      missingProviderCredential: "接続をテストする前にプロバイダー認証情報を追加してください。",
    },
  },
  quickFab: {
