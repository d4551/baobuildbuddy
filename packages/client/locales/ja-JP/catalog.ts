const catalog = {
  ...
  "aiDashboard": {
    "title": "AIダッシュボード",
    "subtitle": "プロバイダーの準備状況を管理し、接続をテストし、希望するモデルを一元的なコントロール画面で設定します。",
    "stats": {
    ...
    "alerts": {
      ...
      "noProvidersDescription": "チャットと生成機能を有効にするには、設定で少なくとも1つのAIプロバイダーを構成してください。",
    ...
    "errors": {
      ...
      "localConnectivityFailed": "ローカルプロバイダーの接続確認に失敗しました。",
      "providerTestFailed": "プロバイダーテストに失敗しました。",
