const catalog = {
  ...
  "aiDashboard": {
    ...
    "subtitle": "Gérez la disponibilité des fournisseurs, testez la connectivité et définissez votre modèle préféré depuis une surface de contrôle centralisée.",
    "stats": {
    ...
    "preference": {
      ...
      "description": "Choisissez le fournisseur principal et le modèle par défaut pour le chat et la génération IA.",
    ...
    "alerts": {
      ...
      "noProvidersDescription": "Configurez au moins un fournisseur d'IA dans Paramètres pour activer le chat et la génération.",
