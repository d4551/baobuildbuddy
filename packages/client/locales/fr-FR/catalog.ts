const catalog = {
  ...
  a11y: {
    ...
    aiConfigIncompleteAria: "Les fournisseurs IA doivent être configurés dans Paramètres",
  },
  layout: {
    shell: {
  ...
  nav: {
    ...
    interviewSession: "Session d'entretien",
    skills: "Compétences",
    skillsPathways: "Parcours de compétences",
    studios: "Studios de jeux",
    studiosAnalytics: "Analytique des studios",
    aiDashboard: "Tableau de bord IA",
    aiChat: "Conversation IA",
    automation: "Automatisation",
    automationJobApply: "Automatisation des candidatures",
    automationScraper: "Automatisation du scraping",
    automationEmail: "Automatisation des e-mails",
  ...
  gamificationPage: {
    ...
    levelUpToast: "Niveau supérieur ! Vous avez atteint le niveau {level} — {title}",
    activity: {
      title: "Activité hebdomadaire et progression de carrière",
      description: "Actions enregistrées sur les sept derniers jours et indicateurs de carrière à long terme.",
      weeklyTitle: "Cette semaine",
      weeklyTotalXp: "{xp} XP gagnés cette semaine",
      daySummary: "{count} actions · {xp} XP",
      weeklyEmpty: "Aucune action enregistrée au cours des sept derniers jours.",
      careerTitle: "Progression de carrière",
      skillCoverage: "Couverture des compétences : {value}%",
      applicationSuccessRate: "Taux de réussite des candidatures : {value}%",
      interviewSessions: "{count} sessions d'entretien enregistrées",
      careerEmpty: "Aucune métrique de progression de carrière pour le moment.",
      emptyTitle: "Aucune activité enregistrée pour le moment",
      emptyDescription:
        "Recherchez des offres, enregistrez des postes et relevez des défis pour commencer à créer une activité hebdomadaire et une progression de carrière.",
      emptyCta: "Parcourir les offres",
      emptyCtaAria: "Ouvrir les offres d'emploi pour commencer à enregistrer de l'activité",
      errorTitle: "Statistiques d'activité indisponibles",
      retryButton: "Réessayer",
      retryAria: "Réessayer le chargement des statistiques d'activité",
    },
  },
  jobsPage: {
    ...
    tabs: {
      aria: "Vues des offres d'emploi",
      browse: "Parcourir",
      browseAria: "Afficher les résultats de découverte d'offres",
      saved: "Enregistrées",
      savedAria: "Afficher les offres enregistrées",
      applied: "Candidatures",
      appliedAria: "Afficher les candidatures",
    },
    saved: {
      emptyTitle: "Aucune offre enregistrée pour le moment",
      emptyDescription:
        "Enregistrez des postes depuis les offres d'emploi pour constituer une sélection pour vos CV et entretiens.",
      emptyCta: "Parcourir les offres",
      emptyCtaAria: "Basculer vers l'onglet de découverte d'offres",
      errorTitle: "Impossible de charger les offres enregistrées.",
      retryButton: "Réessayer",
      retryAria: "Réessayer le chargement des offres enregistrées",
      openSavedAria: "Ouvrir l'offre enregistrée {title} chez {company}",
    },
    applied: {
      emptyTitle: "Aucune candidature pour le moment",
      emptyDescription:
        "Postulez à des postes depuis les offres d'emploi et suivez ici le statut de chaque candidature.",
      emptyCta: "Parcourir les offres",
      emptyCtaAria: "Basculer vers l'onglet de découverte d'offres",
      errorTitle: "Impossible de charger les candidatures.",
      retryButton: "Réessayer",
      retryAria: "Réessayer le chargement des candidatures",
      openApplicationAria: "Ouvrir la candidature pour {title} chez {company}",
      appliedOn: "Candidature envoyée {date}",
      status: {
        applied: "Envoyée",
  ...
  automation: {
    ...
    jobApply: {
      ...
      bootstrapError: "Impossible de charger l'automatisation des candidatures.",
      bootstrapRetry: "Réessayer",
      bootstrapRetryAria: "Réessayer le chargement de l'automatisation des candidatures",
      emptyResumesTitle: "CV requis",
      emptyResumesDescription:
        "Créez un CV avant de lancer l'automatisation des candidatures. L'exécution nécessite un CV sélectionné.",
      emptyResumesCta: "Ouvrir le créateur de CV",
      emptyResumesCtaAria: "Ouvrir le créateur de CV pour créer un CV de candidature",
      jobUrlLegend: "URL de l'offre",
      jobUrlPlaceholder: "Collez l'URL de l'offre d'emploi",
      jobUrlAria: "URL de l'offre d'emploi",
      resumeLegend: "CV",
      resumeAria: "Sélectionner un CV",
      selectResumeOption: "Sélectionner un CV",
      resumeFallbackName: "CV {id}",
      coverLetterLegend: "Lettre de motivation (facultatif)",
      coverLetterAria: "Sélectionner une lettre de motivation facultative",
      noCoverLetterOption: "Aucune lettre de motivation",
      coverLetterOption: "{position} chez {company}",
      unknownCompany: "Inconnu",
      unknownPosition: "Poste",
      jobIdLegend: "ID de poste (facultatif)",
      jobIdPlaceholder: "ID de poste facultatif pour la corrélation",
      jobIdAria: "ID de poste facultatif pour la corrélation",
      runButton: "Lancer la candidature",
      runButtonAria: "Lancer l'automatisation de candidature",
      submitErrorTitle: "Échec de l'envoi",
      submitErrorFallback: "Impossible de démarrer l'automatisation de candidature",
      runStartedTitle: "Exécution lancée",
      runIdLabel: "ID d'exécution : {id}",
      statusLabel: "Statut : {status}",
      openRunDetailLink: "Ouvrir le détail de l'exécution",
      openRunDetailAria: "Ouvrir la page de détail de l'exécution d'automatisation {id}",
      schedule: {
        legend: "Planifier l'exécution",
        aria: "Planifier l'heure d'exécution",
        hint: "Choisissez quand cette exécution doit démarrer.",
        button: "Planifier l'exécution",
        buttonAria: "Planifier l'exécution de l'automatisation de candidature",
        createdTitle: "Exécution planifiée",
        scheduledForLabel: "Planifiée pour : {date}",
        invalidRunAt: "Choisissez une date et une heure futures valides.",
      },
      stream: {
  ...
  settings: {
    ...
    aiProviders: {
      ...
      openaiV1Title: "API Chat Completions OpenAI",
      openaiV1Description:
        "Pointez les SDK OpenAI vers cette URL de base avec votre clé API Bao comme jeton Bearer (models + chat/completions).",
      openaiV1Aria: "URL de base de l'API Chat Completions OpenAI",
      expandAria: "Développer les paramètres du fournisseur {provider}",
      configuredBadge: "Configuré",
      endpointLabel: "URL de l'endpoint",
      credentialLabel: "Clé API",
      huggingFacePlaceholder: "Saisissez le jeton Hugging Face",
      apiKeyPlaceholder: "Saisissez la clé API {provider}",
      testAria: "Tester la connexion du fournisseur IA",
      testButton: "Tester",
      localModelLegend: "Nom du modèle local",
      localModelPlaceholder: "Détecté automatiquement depuis le serveur",
      localModelAria: "Nom du modèle local",
      connectedBadge: "Connecté",
      failedBadge: "Échoué",
      saveAria: "Enregistrer les identifiants du fournisseur IA",
      ...
      readinessTitle: "Préparation des fournisseurs",
      readinessDescription:
        "Vérifiez la configuration et la connectivité avant d'affecter des fournisseurs aux workflows.",
      ...
      routingCoverageTitle: "Workflows routés",
      routingCoverageDescription:
        "Chaque capacité IA peut conserver son propre fournisseur et une surcharge de modèle facultative.",
      ...
      ollamaTipLinkLabel: "Site Ollama",
      ollamaTipLinkAria: "Ouvrir le site Ollama dans un nouvel onglet",
      credentialsDescription:
        "Enregistrez et testez uniquement les identifiants des fournisseurs que vous comptez router vers des workflows actifs.",
    },
    brand: {
    ...
    errors: {
      failedToTestProvider: "Impossible de tester le fournisseur",
      failedToSaveApiKeys: "Impossible d'enregistrer les clés API",
      missingProviderCredential:
        "Ajoutez les identifiants du fournisseur avant de tester la connexion.",
    },
  },
  quickFab: {
